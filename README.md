...
Each shape has a drag handle at its center so you can move it freely. Shapes keep the same size across both maps and remain editable using the Draw control.
